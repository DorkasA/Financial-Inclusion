...
st.markdown("<h4 style = 'margin: -30px; color: #FFB000; text-align: center; font-family: Brush Script MT'> Built By: DORCAS.C. AKPULONU</h4>", unsafe_allow_html = True)
st.markdown("<br>", unsafe_allow_html= True)

st.image('What-is-Financial-Inclusion.png', use_column_width=True)
...
st.sidebar.image('images.png', caption='Welcome User')
